...
u8 Usart3_Receive,Left_Receive,Right_Receive,Run_Flag=0;  //蓝牙遥控相关变量和运行状态标志位
u8 rxbuf[8],Urxbuf[8],CAN_ON_Flag=0,Usart_ON_Flag=1,Usart_Flag,PID_Send,Flash_Send;  //CAN和串口控制相关变量
...
{ 
  ...
  uart3_init(36,9600);            //=====串口3初始化 默认与蓝牙连接
