...
void InitSingleFDC2214(void)
{
    ...
    WriteRegfdc2214(0x1B,0x020F); //通道配置
...
void InitMultiFDC2214(void)//双通道
{
    ...
    WriteRegfdc2214(0x16,0x2002);//分频
  	...
  	WriteRegfdc2214(0x1E,0xF800); //驱动电流 CH0
  	WriteRegfdc2214(0x1F,0xF800); //CH1
	WriteRegfdc2214(0x20,0xF800); //CH2
  	WriteRegfdc2214(0x21,0xF800); //CH3
