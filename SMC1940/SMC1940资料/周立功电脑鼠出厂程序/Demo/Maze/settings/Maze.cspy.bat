...
"C:\Program Files\IAR Systems\Embedded Workbench 4.0 Kickstart\common\bin\cspybat" "C:\Program Files\IAR Systems\Embedded Workbench 4.0 Kickstart\arm\bin\armproc.dll" "C:\Program Files\IAR Systems\Embedded Workbench 4.0 Kickstart\arm\bin\armlmiftdi.dll"  %1 --plugin "C:\Program Files\IAR Systems\Embedded Workbench 4.0 Kickstart\arm\bin\<libsupport_plugin>" --backend -B "--endian" "little" "--cpu" "cortex-M3" "--fpu" "None" "--proc_device_desc_file" "C:\Program Files\IAR Systems\Embedded Workbench 4.0 Kickstart\arm\CONFIG\iolm3s615.ddf" "--drv_verify_download" "all" "--drv_attach_to_program" "--proc_driver" "lmiftdi" "--lmiftdi_speed" "500" 
