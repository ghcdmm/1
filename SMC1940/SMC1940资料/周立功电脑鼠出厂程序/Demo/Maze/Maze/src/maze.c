    ...
    while (1) {
        ...
        case START:                                                     /*  判断电脑鼠起点的横坐标      */
            ...
            if (GucMapBlock[GmcMouse.cX][GmcMouse.cY] & 0x08) {         /*  判断电老鼠左边是否存在出口  */
                 ...
                 *  在OFFSHOOT[0]中保存起点坐标
                 */
                GmcCrossway[gcn].cX = MAZETYPE - 1;
                GmcCrossway[gcn].cY = 0;
                gcn++;
        ...
        case MAZESEARCH:
            ...
            if (ucRoadStat) {                                           /*  有可前进方向                */
                ...
                while (--gcn) {
                    ucRoadStat = crosswayCheck(GmcCrossway[gcn].cX,
                                               GmcCrossway[gcn].cY);
                                                                        /*  统计最近支点未走过的方向数  */
