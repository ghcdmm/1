...
void BUZZ_ON(void);
void BUZZ_OFF(void);
#define Left_motor_go      (GPIO_ResetBits(GPIOB,GPIO_Pin_5),GPIO_SetBits(GPIOB,GPIO_Pin_8))//左电机前进cor
...
#define Right_motor_go     (GPIO_ResetBits(GPIOC,GPIO_Pin_12),GPIO_SetBits(GPIOD,GPIO_Pin_2))//右电机前进
...
extern uint16 Sunlight[4];
extern uint16 ucIRCheck[4];
extern __IO uint16 ADC_ConvertedValue[4];
