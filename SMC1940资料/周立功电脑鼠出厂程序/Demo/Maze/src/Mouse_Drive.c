...
void mouseTurnback(void)
{
    ...
    __GmRight.cDir    = __MOTORGOBACK;
    __GmRight.uiPulse = 81;//162 * 10;
    
    __GmLeft.cDir     = __MOTORGOAHEAD;
    __GmLeft.uiPulse  = 81;//162 * 10;
    __GmLeft.cState   = __MOTORRUN;
    __GmRight.cState  = __MOTORRUN;
...
{
    zlg7289Download(2, 4, 0, __GucDistance[__LEFT  ]);
    zlg7289Download(2, 3, 0, __GucDistance[__FRONTL]);
    zlg7289Download(2, 2, 0, __GucDistance[__FRONT ]);
    zlg7289Download(2, 1, 0, __GucDistance[__FRONTR]);    
    zlg7289Download(2, 0, 0, __GucDistance[__RIGHT ]);    
}
