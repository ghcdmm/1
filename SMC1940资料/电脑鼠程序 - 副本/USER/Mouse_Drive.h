...
void BUZZ_ON(void);
void BUZZ_OFF(void);
#define Right_motor_go      (GPIO_ResetBits(GPIOB,GPIO_Pin_5),GPIO_SetBits(GPIOB,GPIO_Pin_8))//右电机前进cor
#define Right_motor_back    (GPIO_SetBits(GPIOB,GPIO_Pin_5),GPIO_ResetBits(GPIOB,GPIO_Pin_8))//左电机后退
#define Right_motor_stop    (GPIO_SetBits(GPIOB,GPIO_Pin_5),GPIO_SetBits(GPIOB,GPIO_Pin_8)) 	//左电机停止	

#define Left_motor_go     (GPIO_ResetBits(GPIOC,GPIO_Pin_12),GPIO_SetBits(GPIOD,GPIO_Pin_2))//左电机前进
#define Left_motor_back   (GPIO_SetBits(GPIOC,GPIO_Pin_12),GPIO_ResetBits(GPIOD,GPIO_Pin_2))//右电机后退
#define Left_motor_stop   (GPIO_SetBits(GPIOC,GPIO_Pin_12),GPIO_SetBits(GPIOD,GPIO_Pin_2))	//右电机停止
...
/*********************************************************************************************************
  常量宏定义--PID
*********************************************************************************************************/
#define __KP 20 	  //比例 80
#define __KI 0.01       //积分 0.01
#define __KD 0.01        //微分

#define U_MAX 600       //返回的最大值,是pwm的周期值 
#define U_MIN 0 
