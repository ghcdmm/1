...
{  
   ...
   //ÉèÖÃ¸ÃÒý½ÅÎª¸´ÓÃÊä³ö¹¦ÄÜ,Êä³öTIM3 CH1µÄPWMÂö³å²¨ÐÎ
	...
	TIM_OC1Init(TIM5, &TIM_OCInitStructure);  //¸ù¾ÝTIM_OCInitStructÖÐÖ¸¶¨µÄ²ÎÊý³õÊ¼»¯ÍâÉèTIMx

	TIM_CtrlPWMOutputs(TIM5,ENABLE);	//MOE Ö÷Êä³öÊ¹ÄÜ	
...
void IR_GPIO_Config(void)
{
 ...
 GPIO_InitStructure.GPIO_Pin = GPIO_Pin_10;	    		 //Ç°ÓÒºìÍâ·¢Éä-->PA.4 ¶Ë¿ÚÅäÖÃ, ÍÆÍìÊä³ö
 GPIO_Init(GPIOC, &GPIO_InitStructure);	  				 //ÍÆÍìÊä³ö £¬IO¿ÚËÙ¶ÈÎª50MHz
 
 GPIO_InitStructure.GPIO_Pin = GPIO_Pin_11;	    		 //ÓÒÐ±ºìÍâ·¢Éä-->PA.5 ¶Ë¿ÚÅäÖÃ, ÍÆÍìÊä³ö
 GPIO_Init(GPIOC, &GPIO_InitStructure);	  				 //ÍÆÍìÊä³ö £¬IO¿ÚËÙ¶ÈÎª50MHz
 
 GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13;	    		 //ÓÒ²àºìÍâ·¢Éä-->PA.7 ¶Ë¿ÚÅäÖÃ, ÍÆÍìÊä³ö
