...
//		printf("%d ",__GmRight.sSpeed); 
//		printf("%d\n",pulse_R_counter);
//		printf("%f	%f	%f	%f	%f	%f	%f	%f	%f	%f	%f 	",n1,n2,n3,n4,n5,n6,n7,n8,n9,n9,n11);
//		ax=getAccX();
//		printf("加速度：%d	%d	%d	重力：%d %d %d tem:%d\r\n",ax,getAccY(),getAccZ(),getGyroX(),getGyroY(),getGyroZ(),getTemperature());
//		
