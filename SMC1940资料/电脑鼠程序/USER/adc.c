...
__IO uint16 ADC_ConvertedValue[6];
/*********************************************************************************************************
...
// ADC_DeInit(ADC1);
 ...
 ADC_InitStructure.ADC_NbrOfChannel = 6;//通道数目
...
ADC_RegularChannelConfig(ADC1, ADC_Channel_8, 1, ADC_SampleTime_71Cycles5);//front_L
 ...
 ADC_RegularChannelConfig(ADC1, ADC_Channel_4, 4, ADC_SampleTime_71Cycles5);//right
 ADC_RegularChannelConfig(ADC1, ADC_Channel_5, 5, ADC_SampleTime_71Cycles5);
 ADC_RegularChannelConfig(ADC1, ADC_Channel_2, 6, ADC_SampleTime_71Cycles5);//front_R
