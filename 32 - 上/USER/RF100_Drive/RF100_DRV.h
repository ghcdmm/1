...
**
********************************************************************************************************/
#ifndef __RF100_DRV_H
#define __RF100_DRV_H

#ifdef  _RF100_DRV_MANL
#define _EXT_RF100_DRV
#else 
#define _EXT_RF100_DRV    extern 
#endif
...
_EXT_RF100_DRV uint8_t SingleInventCMD[];
_EXT_RF100_DRV uint8_t MultiInventCMD[];
_EXT_RF100_DRV uint8_t StopMultiInventCMD[];
_EXT_RF100_DRV uint8_t SetRegionUSCMD[];
_EXT_RF100_DRV uint8_t SetRegionCH2CMD[];
_EXT_RF100_DRV uint8_t SetSelectModeCMD[];
_EXT_RF100_DRV uint8_t SetSelectParaCMD[];
_EXT_RF100_DRV uint8_t ReadDataCMD[];
_EXT_RF100_DRV uint8_t WriteDataCMD[];	

_EXT_RF100_DRV frame_data_t RF100FRAME;
_EXT_RF100_DRV RF100_STA_t RF100Status;
_EXT_RF100_DRV TAG_STA_t TAG[MAX_TAG_NUM];
_EXT_RF100_DRV unsigned int TAG_Index;
_EXT_RF100_DRV TAG_WR_PARA_t TAG_WR_PARA;
_EXT_RF100_DRV TAG_READ_DATA_t TAG_READ_DATA;

_EXT_RF100_DRV void Usart_buff_copy(uint8_t (*usart_buff)[200],uint8_t data_len,unsigned char j);
_EXT_RF100_DRV uint8_t RF100_FRAME_RX_HANDLE(void);

_EXT_RF100_DRV void TagWriteProcess(uint8_t *t_EPC,TAG_WR_PARA_t t_TAG_WR_PARA);
_EXT_RF100_DRV void TagReadProcess(uint8_t *t_EPC,TAG_WR_PARA_t t_TAG_WR_PARA);
_EXT_RF100_DRV uint8_t EPC_Compare(uint8_t *t_EPC1,uint8_t *t_EPC2);
extern unsigned char dbm[10][2];
