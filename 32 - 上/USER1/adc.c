...
// ADC_RegularChannelConfig(ADC1, ADC_Channel_15,1, ADC_SampleTime_71Cycles5);
 ADC_RegularChannelConfig(ADC1, ADC_Channel_14,2, ADC_SampleTime_71Cycles5);//left
 ADC_RegularChannelConfig(ADC1, ADC_Channel_3, 3, ADC_SampleTime_71Cycles5);//right
// ADC_RegularChannelConfig(ADC1, ADC_Channel_2, 5, ADC_SampleTime_55Cycles5);
 ADC_RegularChannelConfig(ADC1, ADC_Channel_1, 4, ADC_SampleTime_71Cycles5);//front_R
